  ...
  return (
    <div className="fixed bottom-5 right-5 z-[10000] group">
      ...
      >
        {/* Pulse ring */}
        <span
          className="absolute inset-0 rounded-full opacity-60 animate-[whatsapp-pulse_3s_ease-in-out_infinite]"
          style={{ backgroundColor: "#25D366" }}
        />
        {/* WhatsApp icon */}
        <svg
      ...
      {/* Tooltip */}
      <div className="absolute bottom-full right-0 mb-3 px-3 py-1.5 bg-white text-gray-800 text-xs font-medium rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none">
